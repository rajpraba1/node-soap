...
function WSSecurityCert(privatePEM, publicP12PEM, password) {
  ...
  this.signer = new SignedXml(null,  { signatureAlgorithm : 'http://www.w3.org/2001/04/xmldsig-more#rsa-sha512'});
...
WSSecurityCert.prototype.postProcess = function (xml, envelopeKey, signaturePrefix) {
  ...
  return insertStr(this.signer.getSignatureXml().replace(/[\r\n]/g, ''), xmlWithSec, xmlWithSec.indexOf('<wsse:BinarySecurityToken'));
};
